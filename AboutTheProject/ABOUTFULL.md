...
и еще на странице с ai есть мелкий скролл
когда пролистываешь чат полностью то потом в конце глобальной страницы с ai чучуть скролиться
это нужно исправить
еще вот тут корявые модалочки без дизайна когда на странице транзакшионс
наводишься на диограму на статистику и там некрасиво без стиля показывает результат точно так же в странице с favorites с selectом сортировок у него нет дизайна обычный htmloвский селект
