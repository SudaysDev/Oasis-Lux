...
(кстати все логики что естть можно сделать через страничку фулл контрол просто написать там /create "ну тут можно какой небудь банлист создать новый или категорию или тег или все все что есть типо ну в нашем случае мы создаем промокод так что пишет promo" "дальше здесь идут параметры типо на какой срок или на какую дату на что скидка на какой бренд скидка или на какие цвета вот это все тут есть сколько процент скидка, скидка это или кешбек или просто минус какая небудь сумма из цены
так что да вот так вот")

еще на странице фулл контрол когда мы делаем команды то там непросто вот ничего нету там кстати добавь как в дефолтном терминале типа команды /color a или чето типо такое там вот реально выходит
user @nickname was banned(к примеру) by id "его айди"
потом там причина и все такое и вся инфа крч оч много команд и живая консоль терминала которая реально как вот баш показывает все и делает если команда не найдена как в баш пишет команд нот фоунд и то слово или строчка которая непонятна
полная власть над сайтом вообще
там еще во время ввода команд должна показывать похожие команды как в майнкрафте сверху пишешь же /s а там уже сверху появляется все команды в которых есть  эта буква и он там выделена например /sum пишешь остается один вариант нажиаешь enter  и он пишется автоматически
еще есть команды например что можно комуто напистаь сообщение и даже от лица кого это сделать к примеру /send_message @nickname "message" 
или если хочешь от лица кого небудь 
/send_message by @nickname to @nickname "message"
и вот я это все говорю но ты наверное просто добавишь только эти команды и все но нет братела я тебе просто примеры привожу а ты должен сделать всю имбу на подобии этого дополнять и невероятно расширять а не только то что я тебе говорю але
если у тебя есть идеи как сделать команды более удобными то говори братанчик
и еще не забудь что должны быть подсказки в командах как в майнкрафте я же говорил что там пишешь что то и сверху подсказки или например написал /announce @ и там выходит @e - для всех
@a - только я
@i
@o
@u

ну и короче тд ты понял тут я просто примеры привел и сделай дизайн тоже красивым и вот вайбовым как програмирование типо не слишком крутой там дизайн мультяшний а такой вот как в консоли без красивых шрифтов и чего то прочего как в майнкрафте и вообще вот этих консолях
еще админ может там к каждому типо продавцам и продуктам делать так типо включать режим продвижения и если он его включит то эти продавцы или продукт будут чаще поподаться в алгоритмах главной там или каталога



и сделай еще чтоб как в терминалах  была еще вот такая панель еще где небудь с модалками где можно там новый терминал открыть переключаться между ними и все такое 
сделать терминал  во весь экран типо убрать бордеры и сделать его на всю страницу
все вот эти функции кароч